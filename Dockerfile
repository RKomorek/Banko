# Dockerfile para aplicação Next.js com multi-stage build
...
# Definir o diretório correto para o .next
# Verificar https://nextjs.org/docs/advanced-features/output-file-tracing
